...
#endif
	int (*fix_mac_speed)(struct gmac_rockchip_plat *pdata,
...
#ifndef CONFIG_DWC_ETH_QOS
static int px30_gmac_fix_mac_speed(struct gmac_rockchip_plat *pdata,
				   struct rockchip_eth_dev *dev)
{
...
static int rk3228_gmac_fix_mac_speed(struct gmac_rockchip_plat *pdata,
				     struct rockchip_eth_dev *dev)
{
	struct dw_eth_dev *priv = &dev->dw;
...
static int rk3288_gmac_fix_mac_speed(struct gmac_rockchip_plat *pdata,
				     struct rockchip_eth_dev *dev)
{
	struct dw_eth_dev *priv = &dev->dw;
...
static int rk3308_gmac_fix_mac_speed(struct gmac_rockchip_plat *pdata,
				     struct rockchip_eth_dev *dev)
{
	struct dw_eth_dev *priv = &dev->dw;
...
static int rk3328_gmac_fix_mac_speed(struct gmac_rockchip_plat *pdata,
				     struct rockchip_eth_dev *dev)
{
	struct dw_eth_dev *priv = &dev->dw;
...
static int rk3368_gmac_fix_mac_speed(struct gmac_rockchip_plat *pdata,
				     struct rockchip_eth_dev *dev)
{
	struct dw_eth_dev *priv = &dev->dw;
...
static int rk3399_gmac_fix_mac_speed(struct gmac_rockchip_plat *pdata,
				     struct rockchip_eth_dev *dev)
{
	struct dw_eth_dev *priv = &dev->dw;
...
static int rv1108_set_rmii_speed(struct gmac_rockchip_plat *pdata,
				 struct rockchip_eth_dev *dev)
{
	struct dw_eth_dev *priv = &dev->dw;
...
#else
static int rk3588_set_rgmii_speed(struct gmac_rockchip_plat *pdata,
				  struct rockchip_eth_dev *dev)
{
...
static int rv1126_set_rgmii_speed(struct gmac_rockchip_plat *pdata,
				  struct rockchip_eth_dev *dev)
{
	struct eqos_priv *priv = &dev->eqos;
	struct clk clk_speed;
...
static void rv1126_set_to_rmii(struct gmac_rockchip_plat *pdata)
{
...
static int gmac_rockchip_probe(struct udevice *dev)
{
	...
	eth_pdata->phy_interface = config->interface(dev);
#else
	dw_pdata = &pdata->dw_eth_pdata;
	eth_pdata = &dw_pdata->eth_pdata;
#endif
	pdata->bus_id = dev_seq(dev);
